...
class PublishService extends repository_1.Repository {
    ...
    async video(options) {
        ...
        await Bluebird.try(() => this.regularVideo(Object.assign({ video: options.video, isClipVideo: options.isClip, uploadId }, videoInfo))).catch(errors_1.IgResponseError, error => {
            throw new errors_1.IgUploadVideoError(error.response, videoInfo);
        });
